    ...
    <section class="jumbotron text-center">
        <div class="container">
            <h1 class="jumbotron-heading">Lamentamos muito 💔</h1>
            <p class="lead text-muted">Mas aqui você pode inserir todas as informações necessarias para que muitas pessoas ajudem a encontrar o seu pet</p>
            <p>
                <a href="anunciar.php?sit=encontrado" class="btn btn-success my-2">Encontrei um animalzineo :D</a>
            </p>
        </div>
    </section>
            ...
            <form class="was-validated" method="post" enctype="multipart/form-data" action="index.php">
                <div class="form-row">
                    <div class="form-group col-md-9">
                        ...
                        <input type="text" name="formulario[]" class="form-control is-invalid" id="inputNome" placeholder="Como ele se chama" required>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="inputIdade">Idade</label>
                        <input type="text" name="formulario[]" class="form-control is-invalid" id="inputIdade" placeholder="X Meses ou Y anos" required>
                    </div>
                </div>
                ...
                <button type="submit" class="btn btn-primary" name="formulario[]" value="1">Enviar</button>
            </form>
        </div>
    </div>